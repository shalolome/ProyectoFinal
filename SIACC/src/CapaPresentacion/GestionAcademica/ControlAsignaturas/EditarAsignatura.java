...
public class EditarAsignatura extends javax.swing.JDialog {
    ...
    public EditarAsignatura(java.awt.Frame parent, boolean modal, long cod) {
        super(parent, modal);
        initComponents();
    ...
    private void MostrarInformacion(long cod) {
        ...
        Asignatura objBuscar = logica.buscarAsignaturaPorCod(cod);
    ...
    private void initComponents() {
        ...
        setTitle("Actualización de Asignatura");

        pnlFondo.setBackground(new java.awt.Color(255, 255, 255));

        lblTitulo.setFont(new java.awt.Font("Century Gothic", 1, 18)); // NOI18N
        lblTitulo.setText("Actualización de Asignatura");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditarAsignatura dialog = new EditarAsignatura(new javax.swing.JFrame(), true, 0);
