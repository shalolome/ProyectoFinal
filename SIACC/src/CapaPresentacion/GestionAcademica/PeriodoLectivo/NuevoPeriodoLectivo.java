...
public class NuevoPeriodoLectivo extends javax.swing.JDialog {
    ...
    public NuevoPeriodoLectivo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Registro de Período Lectivo");

        pnlFondo.setBackground(new java.awt.Color(255, 255, 255));

        lblTitulo.setFont(new java.awt.Font("Century Gothic", 1, 18)); // NOI18N
        lblTitulo.setText("Nuevo Período Lectivo");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NuevoPeriodoLectivo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NuevoPeriodoLectivo dialog = new NuevoPeriodoLectivo(new javax.swing.JFrame(), true);
