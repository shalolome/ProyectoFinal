...
public class DistributivoDocentes extends javax.swing.JDialog {
    ...
    public DistributivoDocentes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Control de Distributivo de Docentes");

        pnlFondo.setBackground(new java.awt.Color(255, 255, 255));

        lblTitulo.setFont(new java.awt.Font("Century Gothic", 1, 18)); // NOI18N
        lblTitulo.setText("Control de Distributivo de Docentes");
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        NuevoDistributivoDocentes frm = new NuevoDistributivoDocentes((Frame) this.getParent(), true);
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        if (tblListado.getSelectedRow() > -1) {
            ...
            EditarDistributivoDocentes frm = new EditarDistributivoDocentes((Frame) this.getParent(), true, codigo);
            frm.setLocationRelativeTo(null);
            frm.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DistributivoDocentes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DistributivoDocentes dialog = new DistributivoDocentes(new javax.swing.JFrame(), true);
