...
public class NuevoDistributivoDocentes extends javax.swing.JDialog {
    ...
    public NuevoDistributivoDocentes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Registro de Distributivo de Docente");

        pnlFondo.setBackground(new java.awt.Color(255, 255, 255));

        lblTitulo.setFont(new java.awt.Font("Century Gothic", 1, 18)); // NOI18N
        lblTitulo.setText("Nuevo Distributivo de Docente");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NuevoDistributivoDocentes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NuevoDistributivoDocentes dialog = new NuevoDistributivoDocentes(new javax.swing.JFrame(), true);
