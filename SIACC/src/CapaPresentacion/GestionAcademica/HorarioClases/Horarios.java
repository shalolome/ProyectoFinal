...
public class Horarios extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Control de Horarios de Clases");
        ...
        tblListado.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CODIGO", "CURSO", "ASIGNATURA", "DOCENTE", "INICIO", "FINALIZACION", "AÑO LECTIVO"
            }
        ) {
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        NuevoHorario frm = new NuevoHorario((Frame) this.getParent(), true);
        frm.setLocationRelativeTo(null);
        frm.setVisible(true);
    }//GEN-LAST:event_btnNuevoActionPerformed

    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        EditarHorario frm = new EditarHorario((Frame) this.getParent(), true);
        frm.setLocationRelativeTo(null);
        frm.setVisible(true);
