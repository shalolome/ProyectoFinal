...
public class EditarMallaCurricular extends javax.swing.JDialog {
    ...
    public EditarMallaCurricular(java.awt.Frame parent, boolean modal, long cod) {
        super(parent, modal);
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(EditarMallaCurricular.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void MostrarInformacion(long cod) {
        ...
        Malla objBuscar = logica.buscarMallaPorCod(cod);

        setCodigo(objBuscar.getCodigo());

        txtCodigo.setText(String.valueOf(objBuscar.getNombre()));
        txtVigencia.setText(String.valueOf(objBuscar.getDescripcion()));

        Nivel objNivel = new LogicaNivel().buscarNivelPorCod(objBuscar.getCodigoCurso());
        cmbCurso.setSelectedIndex(buscar.retornarIndice(cmbCurso, objNivel.getNombre()));

        Asignatura objAsig = new LogicaAsignatura().buscarAsignaturaPorCod(objBuscar.getCodigoAsignatura());
        cmbAsignatura.setSelectedIndex(buscar.retornarIndice(cmbAsignatura, objAsig.getNombre()));
    }
    ...
    private void initComponents() {
        ...
        setTitle("Actualización de Malla Curricular");

        pnlFondo.setBackground(new java.awt.Color(255, 255, 255));

        lblTitulo.setFont(new java.awt.Font("Century Gothic", 1, 18)); // NOI18N
        lblTitulo.setText("Actualización de Malla Curricular");
        ...
        lypnlFondoLayout.setHorizontalGroup(
            ...
            .addComponent(pnlFondo, javax.swing.GroupLayout.PREFERRED_SIZE, 688, Short.MAX_VALUE)
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarMallaCurricular.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditarMallaCurricular dialog = new EditarMallaCurricular(new javax.swing.JFrame(), true, 0);
