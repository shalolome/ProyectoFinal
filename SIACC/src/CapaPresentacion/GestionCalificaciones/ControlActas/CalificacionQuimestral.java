...
public class CalificacionQuimestral extends javax.swing.JDialog {
    ...
    public CalificacionQuimestral(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        try {
            listarQuimestres();
        } catch (SQLException ex) {
            Logger.getLogger(CalificacionQuimestral.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void actualizarNotas() {
        ...
        long codPerid = ((PeriodoAcademicos) cmbQuimestre.getSelectedItem()).getCodigo();
        ...
        for (int i = 0; i < tblListado.getRowCount(); i++) {
            ...
            DetalleActaParcial objDetActParc = new DetalleActaParcial();

            if (codPerid == 1) {
                //////////////////////////////////////////////////////////////////////////////////////////////
                objDetActParc = new LogicaDetalleParcial().buscarDetPromParcPorCod(3, codMatri, codigoDistributivo);
                if (objDetActParc != null) {
                    tblListado.setValueAt(validar.Redondeo(Double.parseDouble(objDetActParc.getPromedioParcial())*80/100), i, 2);
                }
                //////////////////////////////////////////////////////////////////////////////////////////////

                //////////////////////////////////////////////////////////////////////////////////////////////
                objDetActParc = new LogicaDetalleParcial().buscarDetPromParcPorCod(4, codMatri, codigoDistributivo);
                if (objDetActParc != null) {
                    tblListado.setValueAt(validar.Redondeo(Double.parseDouble(objDetActParc.getPromedioParcial())*80/100), i, 3);
                }
                //////////////////////////////////////////////////////////////////////////////////////////////

                //////////////////////////////////////////////////////////////////////////////////////////////
                objDetActParc = new LogicaDetalleParcial().buscarDetPromParcPorCod(5, codMatri, codigoDistributivo);
                if (objDetActParc != null) {
                    tblListado.setValueAt(validar.Redondeo(Double.parseDouble(objDetActParc.getPromedioParcial())*80/100), i, 4);
                }
                //////////////////////////////////////////////////////////////////////////////////////////////
            } else {
                //////////////////////////////////////////////////////////////////////////////////////////////
                objDetActParc = new LogicaDetalleParcial().buscarDetPromParcPorCod(6, codMatri, codigoDistributivo);
                if (objDetActParc != null) {
                    tblListado.setValueAt(validar.Redondeo(Double.parseDouble(objDetActParc.getPromedioParcial())*80/100), i, 2);
                }
                //////////////////////////////////////////////////////////////////////////////////////////////
                ...
                //////////////////////////////////////////////////////////////////////////////////////////////
                objDetActParc = new LogicaDetalleParcial().buscarDetPromParcPorCod(7, codMatri, codigoDistributivo);
                if (objDetActParc != null) {
                    tblListado.setValueAt(validar.Redondeo(Double.parseDouble(objDetActParc.getPromedioParcial())*80/100), i, 3);
                }
                //////////////////////////////////////////////////////////////////////////////////////////////
                ...
                //////////////////////////////////////////////////////////////////////////////////////////////
                objDetActParc = new LogicaDetalleParcial().buscarDetPromParcPorCod(8, codMatri, codigoDistributivo);
                if (objDetActParc != null) {
                    tblListado.setValueAt(validar.Redondeo(Double.parseDouble(objDetActParc.getPromedioParcial())*80/100), i, 4);
                }
                //////////////////////////////////////////////////////////////////////////////////////////////
            ...
            //////////////////////////////////////////////////////////////////////////////////////////////
            objTipoNota = new LogicaCalificaciones().buscarNotaPorTipo(codMatri,codigoDistributivo,codPerid, 6);
            if (objTipoNota != null) {
                tblListado.setValueAt(validar.Redondeo(Float.parseFloat(objTipoNota.getTotalNota())*20/100), i, 6);
            }
             //////////////////////////////////////////////////////////////////////////////////////////////
        }
    }
    ...
    private void generarPromedio() {
        if (tblListado.getRowCount() != 0) {
            ...
            for (int i = 0; i < tblListado.getRowCount(); i++) {
                ...
                tblListado.setValueAt(validar.Redondeo((promedio) / 3), i, 5);
            ...
            for (int i = 0; i < tblListado.getRowCount(); i++) {
                promedioFinal = promedioFinal + Float.parseFloat(String.valueOf(tblListado.getValueAt(i, 5)))
                        + Float.parseFloat(String.valueOf(tblListado.getValueAt(i, 6)));
                
                tblListado.setValueAt(validar.Redondeo(promedioFinal), i, 7);
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Acta de Calificaciones Quimestrales");
            ...
            .addGroup(pnlFondoLayout.createSequentialGroup()
                ...
                .addGroup(pnlFondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlFondoLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(lblQuimestre, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(pnlFondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private long registroActa(Acta obj) throws SQLException {
        ...
        obj.setCodigoPeriodo(((PeriodoAcademicos) (cmbQuimestre.getSelectedItem())).getCodigo());
