...
public class DetalleActaParcial extends javax.swing.JDialog {
    ...
    LogicaDetalleParcial logica = new LogicaDetalleParcial();

    Mensajes mensaje = new Mensajes();
    private boolean bandera = false;
    private long codigo;
    
    public DetalleActaParcial(java.awt.Frame parent, boolean modal, long cod) {
        super(parent, modal);
        initComponents();
    ...
    private void mostrarInformacion(long cod){
        ...
        PeriodoAcademicos objQuimi = new LogicaPeriodoAcademico().buscarPeriodoAcademicoPorCod(objPeriodo.getCodioPadre());
        txtPeriodo.setText(objQuimi.getNombre()+" - "+objPeriodo.getNombre());
    }
    ...
    private void initComponents() {
        ...
        setTitle("Detalle Actas Parciales");

        pnlFondo.setBackground(new java.awt.Color(255, 255, 255));

        lblTitulo.setFont(new java.awt.Font("Century Gothic", 1, 18)); // NOI18N
        lblTitulo.setText("Detalle Actas de Parciales");
