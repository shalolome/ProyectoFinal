...
public class InscripcionEstudiantil extends javax.swing.JDialog {
    ...
    public InscripcionEstudiantil(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Control de Inscripción Estudiantil");

        pnlFondo.setBackground(new java.awt.Color(255, 255, 255));

        lblTitulo.setFont(new java.awt.Font("Century Gothic", 1, 18)); // NOI18N
        lblTitulo.setText("Control de Inscripción Estudiantil");
        ...
        tblListado.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CODIGO", "CEDULA", "PRIMER NOMBRE", "SEGUNDO NOMBRE", "APELLIDO PATERNO", "APELLIDO MATERNO", "SEXO", "FECHA DE NACIMIENTO", "DIRECCION"
            }
        ) {
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        NuevaInscripcionEstudiantil frm = new NuevaInscripcionEstudiantil((Frame) this.getParent(), true);
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        if (tblListado.getSelectedRow() > -1) {
            ...
            EditarInscripcionEstudiantil frm = new EditarInscripcionEstudiantil((Frame) this.getParent(), true, codigo);
            frm.setLocationRelativeTo(null);
            frm.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InscripcionEstudiantil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InscripcionEstudiantil dialog = new InscripcionEstudiantil(new javax.swing.JFrame(), true);
