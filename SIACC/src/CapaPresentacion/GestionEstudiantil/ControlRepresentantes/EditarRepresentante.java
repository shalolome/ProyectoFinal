...
public class EditarRepresentante extends javax.swing.JDialog {
    ...
    public EditarRepresentante(java.awt.Frame parent, boolean modal, long cod) {
        super(parent, modal);
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(EditarRepresentante.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void MostrarInformacion(long cod) {
        ...
        ///////////////////////////////////////////////////////////////////////////////////
        ///////////////////////////////// Representantes /////////////////////////////////
        Representantes objBuscar = logica.buscarReprentantePorCod(cod);

        setCodigo(objBuscar.getCodigoRepresentante());
        ...
        txtEmail.setText(objBuscar.getEmail());
    ...
    private void initComponents() {
        ...
        setTitle("Actualización de Representante");

        pnlFondo.setBackground(new java.awt.Color(255, 255, 255));

        lblTitulo.setFont(new java.awt.Font("Century Gothic", 1, 18)); // NOI18N
        lblTitulo.setText("Actualización de Representante");
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
            ...
            ///////////////////////////////// Representantes  ////////////////////////////////
            Representantes obj = new Representantes();
            obj.setCodigoRepresentante(codigo);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditarRepresentante dialog = new EditarRepresentante(new javax.swing.JFrame(), true, 0);
