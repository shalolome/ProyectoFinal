...
public class Matriculacion extends javax.swing.JDialog {
    ...
    public Matriculacion(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Control de Matriculación Estudiantil");

        pnlFondo.setBackground(new java.awt.Color(255, 255, 255));

        lblTitulo.setFont(new java.awt.Font("Century Gothic", 1, 18)); // NOI18N
        lblTitulo.setText("Control de Matriculación Estudiantil");
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        NuevaMatricula frm = new NuevaMatricula((Frame) this.getParent(), true);
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        if (tblListado.getSelectedRow() > -1) {
            ...
            EditarMatricula frm = new EditarMatricula((Frame) this.getParent(), true, codigo);
            frm.setLocationRelativeTo(null);
            frm.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Matriculacion dialog = new Matriculacion(new javax.swing.JFrame(), true);
