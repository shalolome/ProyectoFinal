...
public class AsignacionCargos extends javax.swing.JDialog {
    ...
    public AsignacionCargos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Asignación de Cargos");
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        NuevaAsignacionCargo frm = new NuevaAsignacionCargo((Frame) this.getParent(), true);
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        if (tblListado.getSelectedRow() > -1) {
            ...
            EditarAsignacionCargo frm = new EditarAsignacionCargo((Frame) this.getParent(), true, codigo);
            frm.setLocationRelativeTo(null);
            frm.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AsignacionCargos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AsignacionCargos dialog = new AsignacionCargos(new javax.swing.JFrame(), true);
