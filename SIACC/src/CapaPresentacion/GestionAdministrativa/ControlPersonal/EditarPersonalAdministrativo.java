...
public class EditarPersonalAdministrativo extends javax.swing.JDialog {
    ...
    public EditarPersonalAdministrativo(java.awt.Frame parent, boolean modal, long cod) {
        super(parent, modal);
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(EditarPersonalAdministrativo.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        setTitle("Actualización de Personal Administrativo");

        pnlFondo.setBackground(new java.awt.Color(255, 255, 255));

        lblTitulo.setFont(new java.awt.Font("Century Gothic", 1, 18)); // NOI18N
        lblTitulo.setText("Actualización Personal Administrativo");
    ...
    private void MostrarInformacion(long cod) {
        ...
        Personal objBuscar = logica.buscarPersonalPorCod(cod);

        setCodigo(objBuscar.getCodigoPersonal());
        Profesion objProfesion = new LogicaProfesion().buscarProfesionPorCod(objBuscar.getCodigoProfesion());
        cmbProfesion.setSelectedIndex(buscar.retornarIndice(cmbProfesion, objProfesion.getNombre()));
        ...
        txtTelefono.setText(objBuscar.getTelefono());
        txtCelular.setText(objBuscar.getCelular());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarPersonalAdministrativo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditarPersonalAdministrativo dialog = new EditarPersonalAdministrativo(new javax.swing.JFrame(), true, 0);
